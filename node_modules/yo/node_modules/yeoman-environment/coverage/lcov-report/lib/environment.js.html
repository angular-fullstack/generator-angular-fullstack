...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">95.74% <small>(135 / 141)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">81.58% <small>(62 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(20 / 20)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.71% <small>(134 / 140)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  opts.env = this;
  opts.resolved = Generator.resolved || <span class="branch-1 cbranch-no" title="branch not covered" >'unknown';</span>
...
<span class="cstat-no" title="statement not covered" >    moduleId = path.resolve(moduleId);</span>
  }
&nbsp;
...
Environment.enforceUpdate = function (env) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!env.adapter) {
    env.adapter = new TerminalAdapter();
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!env.runLoop) {
    env.runLoop = new GroupedQueue(['initializing', 'prompting', 'configuring', 'default',
    'writing', 'conflicts', 'install', 'end']);
  }
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!env.sharedFs) {
