...
Running `grunt test` will run the client and server unit tests with karma and mocha/jasmine (you can choose whether you'd prefer mocha or jasmine for server-side tests when the app is scaffolded for the first time).
